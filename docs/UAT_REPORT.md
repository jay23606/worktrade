...
- **P1 — Browser UAT absent:** 64 Playwright and axe checks now cover desktop, tablet, phone, zoom/reflow, target sizes, accessible names, modal keyboard behavior, safety reporting, navigation, duplicate-submit protection, PWA behavior, themes, scroll preservation, and guided journeys in CI.
